...
@Component({
  selector: 'app-user-register-tc',
  templateUrl: './user-register-tc.component.html',
  styleUrls: ['./user-register-tc.component.scss']
})
export class UserRegisterTcComponent implements OnInit {
  regForm: FormGroup;
  submitted = false;
  loading = false;
  areacode = '';
