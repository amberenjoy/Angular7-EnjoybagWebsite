 ...
 * @LastEditTime: 2019-10-18 14:55:14
...
export class BaglistService {
  ...
  getBaglist(key, language, currency) {
    return this.http
      .get(`${environment.apiUrl}/products/lines/${key}`, {
        headers,
        responseType: 'text',
        params: {
          lan: language,
  ...
  getBagType(name, language, currency) {
    return this.http
      .get(`${environment.apiUrl}/products/types/${name}`, {
        headers,
        responseType: 'text',
        params: {
          lan: language,
  ...
  getQuerylist(qry, language, currency) {
    return this.http
      .get(`${environment.apiUrl}/products/search/${qry}`, {
        headers,
        responseType: 'text',
        params: {
          lan: language,
  ...
  getBag(sku, language, currency) {
    return this.http
      .get(`${environment.apiUrl}/products/${sku}`, {
        headers,
        responseType: 'text',
        params: {
          lan: language,
